...
public class Peticion implements Runnable {
    ...
    private void Hash() { //Resultado de cifrar un conjuto de bytes.
        try {
    ...
    private void Cert() { //Almacenar un cert que se genera en el cliente
        try {
                    ...
                    if (publicKey.getAlgorithm().equals("RSA")) {
                        ...
                        try (ByteArrayInputStream byin = new ByteArrayInputStream(l)) {
                            while ((n = byin.read(b)) != -1) {
                                ...
                                out.writeUTF("Ok: " + hashb64); //! En el unico sitio donde no se pude hacer
