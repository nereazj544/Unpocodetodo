...
public class Ej7 {
    public static void main(String[] args) {
        ...
        // BufferedReader br = new BufferedReader(new InputStreamReader(System.in));Z
        ...
        System.out.printf(
                "\033[1m> Respuesta:\033[0m m1 tiene el valor de %.2f, m2 tiene el valor de %.2f, d tiene el valor de %.2f. El resultado de G es %.10e. Por lo que F es %.10e\n",
                m1, m2, d, g, f);
